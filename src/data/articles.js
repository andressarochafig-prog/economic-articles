export const articles = [
  {
    ...
    content: [
      ...
      {
        type: "paragraph",
        text: "Outro ponto crucial de se explicitar é o impacto da política monetária. Sob uma Selic elevada, o crédito permanece caro, ocasionando em um adiamento de investimentos produtivos, como a compra de maquinários e a produção em larga escala. Adicionalmente, a valorização do dólar eleva os custos de produção interno ao encarecer os insumos dolarizados amplamente utilizados na agricultura (como fertilizantes químicos, pesticidas e maquinário). Esse processo faz com que o custo marginal seja pressionado, configurando o fenômeno conhecido como Transmissão Cambial.",
      },
      {
        type: "figure",
        number: 3,
      ...
      {
        type: "paragraph",
        text: "Ademais, enquanto questões climáticas e de logística já são tradicionalmente mapeadas pelos produtores, nos últimos anos evidenciou-se um componente subjetivo de peso: a ascensão da cultura ‘Wellness’ e a busca incessante por uma vida saudável. Impulsionado pelo forte apelo midiático e digital, as grandes corporações alimentícias rapidamente identificaram a emergência de um público-alvo disposto a pagar um prêmio de preço por produtos rotulados como saudável ou orgânicos. Esse comportamento desloca a curva de demanda para a direita, evidenciando que, no que tange à saúde e ao bem-estar, a elasticidade-preço da demanda nesse nicho de maior renda tornou-se altamente inelástica, ou seja, para esse público a questão financeira deixa de ser o fator decisivo, uma vez que ela comprará o produto quase independente de quanto ele esteja custando, porque, agora, deixa de ser uma questão financeira ou apenas de saúde, mas também de pertencimento a esse grupo que vem crescendo.",
      },
      {
        type: "paragraph",
        text: "Esse movimento, contudo, gera uma forte barreira econômica de entrada para as classes mais desfavorecidas economicamente e pressiona toda a cadeia de precificação nacional. Em termos mais macroeconômicos, o rápido avanço dessa onda de demanda confronta-se com a rigidez de curto prazo da oferta de alimentos naturais. Essa situação gera um excesso de demanda que, diante da escassez imediata de estoques, força a elevação dos preços de mercado para um novo patamar de equilíbrio, atingindo o bolso dos consumidores brasileiros. Esse aumento de preços atua tanto como um mecanismo de racionamento de mercado, quanto como garantia de cobertura dos custos marginais dos produtores, impedindo o colapso da oferta, mas inviabilizando o acesso democrático ao alimento saudável.",
      },
      {
        type: "heading",
